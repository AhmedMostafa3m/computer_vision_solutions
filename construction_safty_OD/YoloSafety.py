...
model = YOLO("d:\programing\ML & DL\MY Work\construction safty OD v11/best.pt")  # Adjust path if needed
...
cap = cv2.VideoCapture("d:\programing\ML & DL\MY Work\construction safty OD v11\ppe-2.mp4")
